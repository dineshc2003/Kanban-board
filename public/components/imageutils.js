...
import user1 from "../assets/user1.jfif"; // Importing user image for Anoop Sharma
import user2 from "../assets/user2.jpg"; // Importing user image for Yogesh
import user3 from "../assets/user3.jpg"; // Importing user image for Shankar Kumar
import user4 from "../assets/user4.jpg"; // Importing user image for Ramesh
import user5 from "../assets/user5.jpg"; // Importing user image for Suresh
